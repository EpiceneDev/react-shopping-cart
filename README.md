...
- To combat this from happening we're going to refactor our application to use `Context API`, making it easier and more efficent to access data across our application.
